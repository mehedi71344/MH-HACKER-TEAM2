...
devoloper_info={
    "Developer" :  'MH HACKER TEAM',
    "Number" :  number,
    "Status" :  '24-ONLINE',
    "GitHub Url":  'https://github.com/mehedi71344 ',
    "Facebook" :  'https://www.facebook.com/profile.php?id=100075559581279&mibextid=ZbWKwL',
    }
...
note1="""- __Inbox__ Me for Join `MH HACKER`\n- Try tool and **Review**"""
n1=Markdown(note1)
